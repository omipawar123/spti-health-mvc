	...
	<div class="height-90">
		<div class="main-content">
			<div class="container-fluid">
				<h5 class="modal-title" id="exampleModalLabel">Admit Patients
					Overview</h5>
				<hr>
				<div class="row">
					<div class="col-md-12 ">
										...
										<thead>
											...
											<tbody>
												<c:forEach items="${opdHistory}" var="opd">
													<tr>
														<td><span style="font-weight: 500" class="text-info"> ${ DateTimeFormatter.ofPattern("yyyy-MM-dd").format(opd.dateOfTreatment) }</span></td>
														...
														<c:choose>
															...
															<c:otherwise>
																<td><span class="badge rounded-pill bg-danger"><a href="/opds/billingHistory-form/patients/${opd.id }">Pay</a></span></td>
															</c:otherwise>
														</c:choose>
